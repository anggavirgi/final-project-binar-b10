  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 min-h-screen">
        ...
        <div className="absolute desktop:top-36 desktop:right-32 desktopfull:top-14 desktopfull:right-4 z-10 w-full desktop:w-1/3 desktopfull:w-1/4 px-4 overflow-auto">
          <div className="bg-white rounded-lg p-4 shadow-md">
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm bg-purple-500 text-white py-1 px-3 rounded-full">
                  60 Menit
                </span>
              </div>
