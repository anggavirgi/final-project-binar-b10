...
export const Notifikasi = () => {
  ...
  return (
    <div className={`${isMobile ? '':'w-full h-[512px] px-20 py-20 shadow flex flex-col justify-center items-center'}`}>
      {isMobile ? (
        <>
          <HeaderUser />
        </>
      ...
      <div className={`w-full h-[450px] p-6 rounded-bl-2xl rounded-br-2xl flex flex-col justify-start items-center gap-6 ${isMobile ? '':'border border-indigo-600'}`}>
