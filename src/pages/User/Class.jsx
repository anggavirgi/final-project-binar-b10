    ...
    <>
      <div className="bg-[#EBF3FC] min-h-screen">
        {!isMobile ? (
          ...
          <div
            className={`flex justify-between items-center px-6 md:px-36 text-white ${
              isMobile ? "py-2" : "bg-primary py-5"
            }`}
          >
            <div
              className={`flex  ${
        ...
        <div className="desktop:px-28 desktopfull:px-36 py-8 text-sm">
          ...
          {!isMobile ? (
            ...
            <div className="flex items-center justify-between px-4 mb-4">
              ...
              <div className="font-bold text-primary" onClick={openFilter}>
                Filter
              </div>
            </div>
          )}
