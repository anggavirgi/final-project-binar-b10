              ...
              <div className="p-6 pl-8 bg-white rounded-lg shadow">
                ...
                <div className="space-y-4">
                  ...
                  <div className="w-full flex justify-center">
                    <button className="mt-4 font-bold text-lg text-red-500 hover:underline">
                      Hapus Filter
                    </button>
                  </div>
                </div>
              ...
              <div className="flex flex-wrap justify-between">
                ...
                <div className="w-full mb-4">
                  <div className="flex space-x-2">
                    <button className="text-purple-500 bg-white px-4 py-2 rounded-lg w-[20%]">
                      All
                    </button>
                    <button className="bg-[#6148FF] text-white px-4 py-2 rounded-lg shadow w-[50%]">
                      In Progress
                    </button>
                    <button className="text-purple-500 bg-white px-4 py-2 rounded-lg shadow w-[30%]">
                      Selesai
                    </button>
                  </div>
                </div>

                <div className="w-full shadow-xl rounded-3xl sm:w-full md:w-[47%] lg:w-[47%] xl:w-[48%] mb-4 overflow-hidden cursor-pointer" onClick={() => navigate("/detail")}>
