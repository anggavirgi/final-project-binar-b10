...
export const Homepage = () => {
  ...
  return (
    <div>
      ...
      <div className={`bg-[#EBF3FC] py-6 ${isMobile ? '':'px-36'}`}>
        <div className="flex items-center justify-between px-4">
          <div className={`font-bold ${isMobile ? 'text-md':'text-xl'}`}>Kategori Belajar</div>
          <div className="font-bold text-primary">Lihat Semua</div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mt-4 text-sm desktopfull:text-base p-4">
      ...
      <div className={`py-6 ${isMobile ? 'px-2':'px-36'}`}>
        <div className="flex items-center justify-between px-4">
        ...
        <div className={`desktopfull:text-base mt-4 ${isMobile ? 'flex flex-nowrap overflow-x-auto text-sm':'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm'}`}>
          <div className={`rounded-3xl shadow-lg mb-2 ${isMobile ? 'rounded-3xl shadow-lg flex-none w-80 md:w-auto':''}`}>
            <img
              src={img1}
              alt="img1"
